// This component renders a scrollable frame of movie cards with dynamic height adjustment and hover effects.
// It provides a visually appealing way to display a list of movies with smooth animations and navigation controls.

// Props:
// - cards: An array of movie objects to be displayed as cards.
// - genres: An array of genres used to categorize or label the movies.
// - title: A string representing the title of the card frame section.

// Why: This component is designed to enhance the user experience by allowing users to scroll through movie cards
...
const CardFrameMovies = ({ cards, genres, title }) => {
          ...
          <AnimatePresence>
            {cards.map((card, index) => (
              <motion.div
                ...
                className="mx-10"
              >
                <MovieCard key={card.id} movies={card} genres={genres} Index={index} />
              </motion.div>
            ))}
          </AnimatePresence>
        </div>
...
export default CardFrameMovies;